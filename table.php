...
?>
  <tr>
    ...
    <td><?php echo $Result['Comment'];?></td>
      <td><center><a href="form edit.html"><input type="submit" value="EDIT" class="btn btn-outline-danger"></a>&nbsp;<a href="deleteform.html"><input type="submit" value="DELETE" class="btn btn-outline-info"></a></center></td>
  </tr>
<?php
}
?>
